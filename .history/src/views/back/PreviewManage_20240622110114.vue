...
const changeSelect=async(e)=>{
  if(e=="未支付"){
    ...
    previews.value=await clarifyOrderService(page.value,5,1)
    ...
    previews.value=await clarifyOrderService(page.value,5,-3)
    ...
    previews.value=await clarifyOrderService(page.value,5,2)
