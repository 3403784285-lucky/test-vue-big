        ...
        <div class="align-items-start list-user-frame bg-dark">
          ...
          >
            <router-link
              ...
              id="1"
              to="/user/preview"
              :style="{ backgroundColor: (bgColorOne==1) ? '#afb3af7a' : '#212529' }"
            ...
            <router-link
              ...
              id="2"
              to="/user/house"
              :style="{ backgroundColor: (bgColorTwo==2) ? '#afb3af7a' : '#212529' }"
            >
            ...
            <router-link
              ...
              id="3"
              to="/user/info"
              :style="{ backgroundColor: (bgColorThree==3)? '#afb3af7a' : '#212529' }"
            >
              <span @click="clickRouter">我的资料</span></router-link
            >
...
const bgColorOne = ref(0)
const bgColorTwo = ref(2)
