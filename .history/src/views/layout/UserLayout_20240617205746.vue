        ...
        <div class="align-items-start list-user-frame bg-dark">
          ...
          >
            <router-link
              ...
              ><span @click="clickRouter($event)">我的订单</span></router-link
            >
            <router-link
            ...
            >
              <span @click="clickRouter($event)">我的房源</span></router-link
            >
...
const bgColor = ref(1)
const clickRouter = (event) => {
  flagDisabled.value=!flagDisabled.value
  bgColor.value=event.currentTarget.id
  console.log(bgColor.value)
  console.log("哈哈哈哈"+JSON.stringify(event))
}
